          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-gray-900">Jack Epsimos - Performance & Environment Services</div>
                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
                  <circle cx={1} cy={1} r={1} />
                </svg>
                <div className="text-gray-600">Optus</div>
              </div>
            </figcaption>
          </figure>
        </div>
        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              />
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-gray-900">Einat Zobel -  </div>
                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
                  <circle cx={1} cy={1} r={1} />
                </svg>
                <div className="text-gray-600">Project Manager of Lion Pty Limited</div>
              </div>
            </figcaption>
          </figure>
        </div>
        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              />
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-gray-900">Digby Wilson </div>
                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
                  <circle cx={1} cy={1} r={1} />
                </svg>
                <div className="text-gray-600">Head of Provisioning -Optus</div>
              </div>
            </figcaption>
          </figure>
        </div>
