...
const Blog = () => {
  return (
    <div>
      <div id="blog" className="mb-12 space-y-2 text-center">
        <h2 className="text-3xl font-bold text-gray-800 md:text-4xl dark:text-black">Latest Articles</h2>
        <p className="lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-500">
      ...
      <div className="m-9 p-4 h-4 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
