...
const Body = () => {
  return (
    <div className="Main">
      ...
      <div className="mx-auto max-w-2xl py-40 sm:py-40 lg:py-20">
        ...
        <div className="text-center">
          ...
          Shape and lead the Providing high quality and Innovative Services and Solutions.
          </h1>
      ...
      <div
        className="absolute inset-x-0 top-[calc(100%-13rem)] -z-9 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
        aria-hidden="true"
      >
        <div
